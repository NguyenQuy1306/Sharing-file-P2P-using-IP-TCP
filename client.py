...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.register_button = customtkinter.CTkButton(self, text="Đăng ký", command=lambda: 
                                self.enter_app(controller=controller, port=self.port_entry.get(), page=RegisterPage),fg_color="#192655")
        ...
        self.login_button = customtkinter.CTkButton(self, text="Đăng nhập", command=lambda: 
                                self.enter_app(controller=controller, port=self.port_entry.get(), page=LoginPage),fg_color="#192655")
...
class RegisterPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Submit
        customtkinter.CTkButton(self.frame, text='Đăng ký', fg_color="#192655",command=lambda: 
        ...
        customtkinter.CTkButton(self.frame, text='Đăng nhập', fg_color="#192655",command=lambda: controller.show_frame(LoginPage)).pack(pady=(0, 10),padx=1)
...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        customtkinter.CTkButton(self.frame, text='Đăng nhập', fg_color="#192655", command=lambda:
        ...
        customtkinter.CTkButton(self.frame, text='Đăng ký', fg_color="#192655", cursor="hand2", command=lambda: controller.show_frame(RegisterPage)).pack(pady=(0, 10),padx=10)
